...
DT_BUFF_ENT_PATIENT = 7
DT_BUFF_FLOAT_PATIENT_START_TIME = 10
DT_BUFF_FLOAT_PATIENT_DURATION = 11
DT_BUFF_INT_PATIENT_COLOR_ID = 6

PATIENT_COLOR_GRAY = 1
PATIENT_COLOR_RED = 2
PATIENT_COLOR_BLUE = 3
PATIENT_COLOR_GREEN = 4
